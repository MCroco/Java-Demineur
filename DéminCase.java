...
public class DéminCase extends JPanel implements MouseListener {
	...
	private Graphisme graphisme = null; //l'objet qui contient les graphismes. Il est indiqué par setGraphisme(Graphisme)
