							...
							public void actionPerformed(ActionEvent e) {
								...
								if(tab.getCase(cooX, cooY).equals("0")) {
									...
									if (isAllFound(aff, tab)) {
										...
										affichageChat += "VOUS AVEZ GAGNE LA PARTIE\n";
										txtrAfficheLeMessage.setText(affichageChat);
										...
										Position posBonusBombe = tab.getBombe()[indexBombe];
										btn.setText(tab.getCase(posBonusBombe.getLigne(), posBonusBombe.getColonne()));
								...
								if(tab.getCase(cooX, cooY).equals("x")) {
									...
									if (!((Math.random()*100)< 40)) {
										...
										txtrAfficheLeMessage.setForeground(Color.RED);
										affichageChat += "LA BOMBE N'A PAS EXPLOSE ! OUF\n";
										txtrAfficheLeMessage.setText(affichageChat);
									}
